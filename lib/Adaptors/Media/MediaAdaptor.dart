...
import 'package:dartotsu/Api/Anilist/Screen/AnilistHomeScreen.dart';
...
class _MediaAdaptorState extends State<MediaAdaptor> {
  ...
  void _updateMediaList() {
    ...
    state.mediaList.value = data.mediaList ?? mediaList;
  }
...
/*  Future<void> _loadData() async {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Text('Media Adaptor Type: ${state.mediaList.length}'),
                                        ...
                                        ? Skeletonizer(
                                            child: ClipRRect(
                                              ...
                                              child: Container(
                                                ...
                                                width:
                                                    108 * multiplicationFactor,
                                                height:
                                                    160 * multiplicationFactor,
                                              ),
                                            ),
                                          )
  ...
  Widget _mediaItem(int index, Media media) {
    return MouseRegion(
      ...
      child: GestureDetector(
        onTap: () => data.onMediaTap?.call(index, media),
        child: SizedBox(
          width: 108 * multiplicationFactor,
          height: 160 * multiplicationFactor,
          child: ClipRRect(
