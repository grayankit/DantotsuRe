...
Data _$DataFromJson(Map<String, dynamic> json) => Data(
  lookupMapping: json['lookupMapping'] == null
      ? null
      : LookupMapping.fromJson(json['lookupMapping'] as Map<String, dynamic>),
);
...
Map<String, dynamic> _$LookupMappingToJson(LookupMapping instance) =>
    <String, dynamic>{'id': instance.id, 'episodes': instance.episodes};

Episodes _$EpisodesFromJson(Map<String, dynamic> json) => Episodes(
  nodes: (json['nodes'] as List<dynamic>?)
      ?.map((e) => e == null ? null : Node.fromJson(e as Map<String, dynamic>))
      .toList(),
);
...
Original _$OriginalFromJson(Map<String, dynamic> json) =>
    Original(url: json['url'] as String?);
...
Titles _$TitlesFromJson(Map<String, dynamic> json) =>
    Titles(canonical: json['canonical'] as String?);
